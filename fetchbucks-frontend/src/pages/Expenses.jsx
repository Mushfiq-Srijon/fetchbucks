...
const injectStyles = () => {
  ...
  s.textContent = `
    ...
    /* Key fix: page header always full width */
    .fb-page-header {
  ...
  return (
    <div className="fb-page-cols" style={{display:'flex', gap:28, alignItems:'flex-start', width:'100%'}}>
      ...
      <div style={{flex:1, minWidth:0, width:'100%'}}>
        ...
        {/* Page title + Add button — always full width */}
        ...
        <div className="fb-list-card">
          ...
          {expenses.length===0 ? (
            <div style={{textAlign:'center',padding:'56px 24px',display:'flex',flexDirection:'column',alignItems:'center',width:'100%',boxSizing:'border-box'}}>
              ...
              <div key={exp.id} className="fb-row fb-fade-up" style={{animationDelay:`${i*0.04}s`}}>
                <div style={{display:'flex',alignItems:'center',gap:12,minWidth:0,flex:'1 1 200px'}}>
                  ...
                  <div style={{minWidth:0}}>
                    ...
                    <div style={{fontSize:13,color:'#7eb8f7',marginTop:3,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>
                ...
                <div style={{flex:'0 0 110px',minWidth:80,textAlign:'right',fontSize:16,fontWeight:700,color:'#e8edf5',letterSpacing:'-0.3px'}}>{taka(exp.amount)}</div>
